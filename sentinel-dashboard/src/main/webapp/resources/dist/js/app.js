...
angular.module("sentinelDashboardApp", ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog", "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard", "selectize", "angularUtils.directives.dirPagination"]).factory("AuthInterceptor", ["$window", "$state", function(t, r) {
    return {
        responseError: function(e) {
            return 401 === e.status && (t.localStorage.removeItem("session_sentinel_admin"),
                r.go("login")),
                e
        },
        response: function(e) {
    ...
    (app = angular.module("sentinelDashboardApp")).service("FlowServiceV1", ["$http", function(a) {
        ...
        this.queryMachineRules = function(e, t, r) {
            ...
            this.checkRuleValid = function(e) {
                return void 0 === e.resource || "" === e.resource ? (alert("资源名称不能为空"),
                    !1) : void 0 === e.count || e.count < 0 ? (alert("限流阈值必须大于等于 0"),
                    !1) : void 0 === e.strategy || e.strategy < 0 ? (alert("无效的流控模式"),
                    !1) : 1 != e.strategy && 2 != e.strategy || void 0 !== e.refResource && "" != e.refResource ? void 0 === e.controlBehavior || e.controlBehavior < 0 ? (alert("无效的流控整形方式"),
                    !1) : 1 == e.controlBehavior && t(e.warmUpPeriodSec) ? (alert("预热时长必须大于 0"),
                    !1) : 2 == e.controlBehavior && t(e.maxQueueingTimeMs) ? (alert("排队超时时间必须大于 0"),
                    !1) : !e.clusterMode || void 0 !== e.clusterConfig && void 0 !== e.clusterConfig.thresholdType || (alert("集群限流配置不正确"),
                    !1) : (alert("请填写关联资源或入口"),
                    !1)
            }
    }
    ...
    (app = angular.module("sentinelDashboardApp")).service("DegradeService", ["$http", function(a) {
        this.queryMachineRules = function(e, t, r) {
            ...
            ,
            this.checkRuleValid = function(e) {
                if (void 0 === e.resource || "" === e.resource)
                    return alert("资源名称不能为空"),
                        !1;
                if (void 0 === e.grade || e.grade < 0)
                    return alert("未知的降级策略"),
                        !1;
                if (void 0 === e.count || "" === e.count || e.count < 0)
                    return alert("降级阈值不能为空或小于 0"),
                        !1;
                if (null == e.timeWindow || "" === e.timeWindow || e.timeWindow <= 0)
                    return alert("熔断时长必须大于 0s"),
                        !1;
                if (null == e.minRequestAmount || e.minRequestAmount <= 0)
                    return alert("最小请求数目需大于 0"),
                        !1;
                if (null == e.statIntervalMs || e.statIntervalMs <= 0)
                    console.log("aaa=" + e.statIntervalMs);
                    return alert("统计窗口时长需大于 0s"),
                        !1;
                if (void 0 !== e.statIntervalMs && 12e4 < e.statIntervalMs)
                    return alert("统计窗口时长不能超过 120 分钟"),
                        !1;
                if (1 == e.grade && 1 < e.count)
                    return alert("异常比率超出范围：[0.0 - 1.0]"),
                        !1;
                if (0 == e.grade) {
                    if (null == e.slowRatioThreshold)
                        return alert("慢调用比率不能为空"),
                            !1;
                    if (e.slowRatioThreshold < 0 || 1 < e.slowRatioThreshold)
                        return alert("慢调用比率超出范围：[0.0 - 1.0]"),
                            !1
                }
                return !0
            }
    ...
    angular.module("sentinelDashboardApp").service("ParamFlowService", ["$http", function(a) {
        function o(e) {
            return !("int" !== (r = e.classType) && "double" !== r && "float" !== r && "long" !== r && "short" !== r || void 0 !== (t = e.object) && "" !== t && !isNaN(t)) || (!!("byte" === e.classType && (a = e.object,
                o = -128,
                l = 127,
            void 0 === a || "" === a || isNaN(a) || a < o || l < a)) || (void 0 === e.object || void 0 === e.classType || (void 0 === (i = e.count) || "" === i || isNaN(i) || i < 0)));
            var t, r, a, o, l, i
        }
        this.queryMachineRules = function(e, t, r) {
            return a({
            ...
            this.checkRuleValid = function(e) {
                if (!e.resource || "" === e.resource)
                    return alert("资源名称不能为空"),
                        !1;
                if (1 != e.grade)
                    return alert("未知的限流模式"),
                        !1;
                if (e.count < 0)
                    return alert("限流阈值必须大于等于 0"),
                        !1;
                if (void 0 === e.paramIdx || "" === e.paramIdx || isNaN(e.paramIdx) || e.paramIdx < 0)
                    return alert("热点参数索引必须大于等于 0"),
                        !1;
                if (void 0 !== e.paramFlowItemList)
                    for (var t = 0; t < e.paramFlowItemList.length; t++) {
                        var r = e.paramFlowItemList[t];
                        if (o(r))
                            return alert("热点参数例外项不合法，请检查值和类型是否正确：参数为 " + r.object + ", 类型为 " + r.classType + ", 限流阈值为 " + r.count),
                                !1
                    }
                return !0
            }
    ...
    angular.module("sentinelDashboardApp").service("AuthorityRuleService", ["$http", function(a) {
        this.queryMachineRules = function(e, t, r) {
            ...
            this.checkRuleValid = function(e) {
                return void 0 === e.resource || "" === e.resource ? (alert("资源名称不能为空"),
                    !1) : void 0 === e.limitApp || "" === e.limitApp ? (alert("流控针对应用不能为空"),
                    !1) : void 0 !== e.strategy || (alert("必须选择黑白名单模式"),
                    !1)
            }
    }
    ]),
    ...
    (app = angular.module("sentinelDashboardApp")).service("GatewayApiService", ["$http", function(a) {
        this.queryApis = function(e, t, r) {
            ...
            this.checkApiValid = function(e, t) {
                if (void 0 === e.apiName || "" === e.apiName)
                    return alert("API名称不能为空"),
                        !1;
                if (null == e.predicateItems || 0 === e.predicateItems.length)
                    return alert("至少有一个匹配规则"),
                        !1;
                for (var r = 0; r < e.predicateItems.length; r++) {
                    var a = e.predicateItems[r].pattern;
                    if (void 0 === a || "" === a)
                        return alert("匹配串不能为空，请检查"),
                            !1
                }
                return -1 === t.indexOf(e.apiName) || (alert("API名称(" + e.apiName + ")已存在"),
                    !1)
            }
    }
    ]),
        ...
        this.queryRules = function(e, t, r) {
            ...
            this.checkRuleValid = function(e) {
                ...
                if (null != e.paramItem && (2 == e.paramItem.parseStrategy || 3 == e.paramItem.parseStrategy || 4 == e.paramItem.parseStrategy)) {
                    if (void 0 === e.paramItem.fieldName || "" === e.paramItem.fieldName)
                        return alert("当参数属性为Header、URL参数、Cookie时，参数名称不能为空"),
                            !1;
                    if ("" === e.paramItem.pattern)
                        return alert("匹配串不能为空"),
                            !1
                }
                return !(void 0 === e.count || e.count < 0) || (alert((1 === e.grade ? "QPS阈值" : "线程数") + "必须大于等于 0"),
                    !1)
            }
    }
    ]);
